...
export function ProjecaoCard({ client }: Props) {
  const proj = calcProjecao(client);
  ...
  return (
    <div className="bg-brand-medium border border-brand-light rounded-xl p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          <p className="text-xs text-[var(--text-secondary)] uppercase tracking-widest mb-1">Projeção — {proj.label}</p>
